...
# Better horizontal layout using 4 columns
    ...
    col_check1, col_check2, col_check3,col_check4 = col2.columns([0.8, 0.8, 0.7, 0.6])
    checkbox_columns = [col_check1, col_check2, col_check3, col_check4]
    
    selected_clusters = []
    for i, cluster in enumerate(cluster_labels):
        if checkbox_columns[i].checkbox(cluster, value=True):
